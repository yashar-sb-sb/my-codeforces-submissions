...
unordered_map<int, vector<pii>> intervals;
...
int main()
{
    ...
    last.reserve(1000000);
    last.bucket_size(500000);
    last.max_load_factor(0.5);
    intervals.reserve(1000000);
    intervals.bucket_size(500000);
    intervals.max_load_factor(0.5);
    int n, m, l, r;
    cin>>n>>m;
    for(int i = 1; i <= n; ++i)
        cin>>A[i];
